...
public interface AccountBrandingJpaRepo extends JpaRepository<AccountBranding, Long> {
    ...
    String BROWSE_POPULATION =
            ...
            + "and (:orgFilterOff = true or exists (select 1 from StudentCertificate sc "
            + "  where sc.owner = b.account and sc.disciplineCode = :disciplineCode "
            + "  and sc.verification.status = com.diving.pungdong.certificate.CertificateVerificationStatus.VERIFIED "
            + "  and sc.organizationCode in :organizationCodes)) "
